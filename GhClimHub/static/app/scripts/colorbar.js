	...
	selection.selectAll(".pointer").remove()
		...
		return (
			...
			pointers
				...
				.duration(1000)
				.attr('opacity',1)
				.attr('transform', orient==="vertical" ?"translate(0," + (fillLegendScale(inputNumbers))+ ')':"translate(" + (fillLegendScale(inputNumbers))+ ',0)' )
		...
		non_position_variable = "y"
			...
			var new_colorbars = svg.enter()
				...
				//.attr("x",function(d) {return d[0]-margin.right})// .attr("y",function(d) {return d[1]-margin.top})
